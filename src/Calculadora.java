...
public class Calculadora {
	...
	//Criando variavel capaz de armazenar dados numericos com casas decimais
		...
		System.out.println("A multilicação entre os dois valores informados é " + multiplicacao);
